// models/address_data_model.dart (NEW FILE)
// 경로: lib/models/address_data_model.dart

// 주소 데이터를 관리하는 클래스
class AddressData {
  // 제공된 주소 데이터를 static 상수로 저장
  static const Map<String, List<String>> koreanAddresses = {
